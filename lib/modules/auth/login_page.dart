...
class LoginScreen extends GetView<AuthController> {
        ...
        child: ConstrainedBox(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Icon(Icons.task_alt, size: config.logoSize, color: config.iconColor ?? GFColors.PRIMARY),
                ...
                Obx(() => _buildFormField(
                      ...
                      nextFocusNode:
                          deviceType == DeviceType.tv ? loginButtonFocusNode : null,
                ...
                Align(
                  alignment: deviceType == DeviceType.tv
                      ? Alignment.center
                  ...
                  child: GFButton(
                    ...
                    size: GFSize.MEDIUM,
                    padding: config.buttonPadding ?? EdgeInsets.zero,
                  ),
                ),
                ...
                Row(
                  ...
                  children: [
                    Text("¿No tienes una cuenta?", style: config.captionStyle ?? const TextStyle(color: Colors.grey)),
                    GFButton(
                      onPressed: () {
  ...
  Widget _buildWatchLoginScreen(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Text("Watch login form (reducido)", style: TextStyle(color: Colors.white)),
      ),
    );
  }
...
class _LayoutConfig {
  ...
  factory _LayoutConfig.fromDevice(
      DeviceType type, ColorScheme cs, TextTheme ts) {
    switch (type) {
      case DeviceType.tv:
        return _LayoutConfig(
          ...
          buttonPadding: const EdgeInsets.symmetric(horizontal: 20, vertical: 15),
        );
